...
# ══════════════════════════════════════════════════════════════════════
def _add_chart(spreadsheet, ws_id: int, chart_type: str,
               title: str,
               domain_range: dict, data_ranges: list,
               position: dict) -> dict:
    """
    Build a chart request.
    position = {col, row, width_cols, height_rows} in grid units
    """
    series = []
            ...
            "chart": {
                ...
                "position": {
                    "overlayPosition": {
                        ...
                        "widthPixels":  position.get("width",  480),
                        "heightPixels": position.get("height", 260),
                    }
                }
            }
        }
...
def write_full_dashboard(report: dict,
    ...
    # ── CHART DATA SECTION (rows 9 onwards) ───────────────────────────
